...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn(
        "z-50 overflow-hidden rounded-[var(--radius-xs)] border border-border-strong bg-primary px-2.5 py-1.5 text-[12px] font-medium text-primary-foreground shadow-[var(--shadow-md)]",
